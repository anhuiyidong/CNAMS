...
<div region="center" style="padding:5px;" border="false">
  <div class="easyui-panel" title="当前位置：用户与权限 &gt; 组织机构管理 &gt; 导入组织机构" style="width:auto;padding:10px;" fit="true">
	<form method="post" action="${ctx }/finedo/organization/importOrg" id="ajaxForm" name="ajaxForm" enctype="multipart/form-data">	
		<table width="80%" border="0" cellpadding="0" cellspacing="0" class="input-table">
		  ...
		  <tr>
		  	...
		  	<td>
		  		<a href="${ctx}/finedo/file/download?fileid=ORG_IMPORT" >组织机构信息批量导入Excel模板 </a>
		  	</td>
		  </tr>
		</table>
	</form>
