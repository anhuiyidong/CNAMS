...
<div region="center" style="padding:5px;" border="false">
  <div class="easyui-panel" title="当前位置：权限资源管理  &gt; 模块管理 &gt; 修改模块" style="width:auto;padding:10px;" fit="true">
	<form method="post" action="${ctx }/finedo/module/modify?moduleid=${module.moduleid}" id="ajaxForm" >		
