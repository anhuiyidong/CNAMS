...
<div>
    ...
    <form method="post" action="${ctx }/finedo/timer/add" id="ajaxForm" name="ajaxForm">
    	...
    	<div class="finedo-nav-title">基本信息</div>
	   	<ul class="finedo-ul">
			...
			<li>
				...
				<fsdp:text id="name" style="width:600px;"/>
			</li>

           	<li>
           		<span class="finedo-label-title"><font color=red>*</font>Bean类名</span>
           		<fsdp:text id="beanname" hint="请填写Bean类名，如：CleanerTimer,注意不需要前面的package名" />
           	</li>

           	<li>
           		<span class="finedo-label-title"><font color=red>*</font>Bean类方法名</span>
           		<fsdp:text id="method" hint="请填写需要执行的Bean类方法名，如：doWork"/>
           	</li>
           	
           	<li>
           		<span class="finedo-label-title"><font color=red>*</font>CRON</span>
           		<fsdp:text id="cron" hint="如: 每5分钟执行一次示例: * 0/5 * * * *, 格式说明: 秒 分 时 日 月 星期, 其中以空格间隔"/>
           	</li>
        </ul>
