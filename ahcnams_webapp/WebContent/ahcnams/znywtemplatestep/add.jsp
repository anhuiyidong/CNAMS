...
<div>
	<div class="add-common-head">
    	<div class="add-common-name-add">新建模板步骤<br/>
            <ul>
    ...
    <div id="excel_add_div" style="display:none"> 
   		<form method="post" action="${ctx }/finedo/znywtemplatestep/importexcel" id="importForm" name="importForm">
		...
		<ul class="finedo-ul">
			<li>
				<span class="finedo-label-title">模板下载</span><span class="finedo-label-info"><a href="import.xlsx" >模板步骤信息批量导入Excel模板 </a></span>
			</li>
			
			<li>
				<span class="finedo-label-title">第1列：</span><span class="finedo-label-info">步骤名称</span>
			</li>
			<li>
				<span class="finedo-label-title">第2列：</span><span class="finedo-label-info">脚本</span>
			</li>
			<li>
				<span class="finedo-label-title">第3列：</span><span class="finedo-label-info">关联网元id</span>
			</li>
			<li>
				<span class="finedo-label-title">第4列：</span><span class="finedo-label-info">备注</span>
			</li>
		</ul>
	</div>
</div>
