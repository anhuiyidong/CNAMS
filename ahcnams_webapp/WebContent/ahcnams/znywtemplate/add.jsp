...
<div>
	<div class="add-common-head">
    	<div class="add-common-name-add">新建模板<br/>
            <ul>
    	...
    	<div class="finedo-nav-title">基本信息</div>
	   	<ul class="finedo-ul">
				...
				<li>
					...
					<fsdp:text id="templatestatus" hint="模板状态" />
				</li>
				<li>
    ...
    <div id="excel_add_div" style="display:none"> 
   		<form method="post" action="${ctx }/finedo/znywtemplate/importexcel" id="importForm" name="importForm">
		...
		<ul class="finedo-ul">
			<li>
				<span class="finedo-label-title">模板下载</span><span class="finedo-label-info"><a href="import.xlsx" >模板信息批量导入Excel模板 </a></span>
			</li>
			
			<li>
				<span class="finedo-label-title">第1列：</span><span class="finedo-label-info">模板名称</span>
			</li>
			<li>
				<span class="finedo-label-title">第2列：</span><span class="finedo-label-info">创建者</span>
			</li>
			<li>
				<span class="finedo-label-title">第3列：</span><span class="finedo-label-info">创建时间</span>
			</li>
			<li>
				<span class="finedo-label-title">第4列：</span><span class="finedo-label-info">模板状态</span>
			</li>
			<li>
				<span class="finedo-label-title">第5列：</span><span class="finedo-label-info">备注</span>
			</li>
		</ul>
	</div>
</div>
