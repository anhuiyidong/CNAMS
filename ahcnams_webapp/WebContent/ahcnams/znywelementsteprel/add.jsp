...
function checkdata() {
	...
	*/
	var result=finedo.validate({
		"eletid":{label:"网元id", datatype:"string", required:true},
...
<div>
	<div class="add-common-head">
    	<div class="add-common-name-add">新建网元和模板步骤对应关系<br/>
            <ul>
    ...
    <form method="post" action="${ctx }/finedo/znywelementsteprel/add" id="ajaxForm" name="ajaxForm">
    <div id="common_add_div" >
    	<div class="finedo-nav-title">基本信息</div>
	   	<ul class="finedo-ul">
				<li>
					<span class="finedo-label-title"><font color=red>*</font>网元id</span>
					<fsdp:text id="eletid" hint="网元id" />
				</li>
				<li>
    ...
    <div id="excel_add_div" style="display:none"> 
   		<form method="post" action="${ctx }/finedo/znywelementsteprel/importexcel" id="importForm" name="importForm">
		...
		<ul class="finedo-ul">
			<li>
				<span class="finedo-label-title">模板下载</span><span class="finedo-label-info"><a href="import.xlsx" >网元和模板步骤对应关系信息批量导入Excel模板 </a></span>
			</li>
			
			<li>
				<span class="finedo-label-title">第1列：</span><span class="finedo-label-info">网元id</span>
			</li>
			<li>
