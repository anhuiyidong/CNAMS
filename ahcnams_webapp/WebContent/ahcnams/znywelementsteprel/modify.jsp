...
<div>
	<div class="add-common-head">
    	<div class="add-common-name-add">修改网元和模板步骤对应关系<br/>
            <ul>
    ...
    <form method="post" action="${ctx }/finedo/znywelementsteprel/modify" id="ajaxForm" name="ajaxForm">
	<input value="${znywelementsteprel.relid}" id="relid" name="relid" type="hidden"/>
    <div class="finedo-nav-title">基本信息</div>
		<ul class="finedo-ul">
			<li>
				<span class="finedo-label-title"><font color=red>*</font>网元id</span>
				<fsdp:text id="eletid" hint="网元id" value="${znywelementsteprel.eletid}" />
			</li>
			<li>
				<span class="finedo-label-title"><font color=red>*</font>步骤id</span>
				<fsdp:text id="stepid" hint="步骤id" value="${znywelementsteprel.stepid}" />
			</li>
		</ul>
