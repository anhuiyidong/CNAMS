...
//文件上传url
var file_uploadurl = ctx + "/finedo/file/webupload";
//文件删除url
...
//缩略图url
var file_thumbnailurl = ctx + '/finedo/file/downloadthumbnail';
//绑定文件与实体
var file_bindentityurl = ctx + "/finedo/file/bindentity";
//检查文件分块是否已上传
var file_checkchunkurl = ctx + "/finedo/file/checkchunk";
//文件上传成功，合并分块
var file_mergechunksurl = ctx + "/finedo/file/mergechunks";
...
;(function($, undefined) {
	...
	$.fn.webupload = function(options){
		...
		var default_options = {
            ...
            auto: true,
            //swf文件路径
            swf: ctx+'/resource/js/finedoui/upload/webuploader/Uploader.swf',
            // 文件接收服务端。
