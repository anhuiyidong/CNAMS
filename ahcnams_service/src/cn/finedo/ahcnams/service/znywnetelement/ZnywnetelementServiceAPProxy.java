...
public class ZnywnetelementServiceAPProxy {
	private ZnywnetelementServiceAPProxy() {
	}
			
	public static ReturnValueDomain<PageDomain<Znywnetelement>> query(ZnywnetelementQueryDomain arg) {
		String apuri="service/finedo/znywnetelement/query";
		...
		// 跨域调用，网络调用
		ReturnValueDomain<PageDomain<Znywnetelement>> ret = ServiceCaller.call(apuri + "?token=" + token, arg, new TypeReference<ReturnValueDomain<PageDomain<Znywnetelement>>>() {});
		return ret;
	}
	
	public static ReturnValueDomain<String> add(ZnywnetelementListDomain arg) {
		String apuri="service/finedo/znywnetelement/add";
	...
	public static ReturnValueDomain<String> update(ZnywnetelementListDomain arg) {
		String apuri="service/finedo/znywnetelement/update";
	...
	public static ReturnValueDomain<String> delete(ZnywnetelementListDomain arg) {
		String apuri="service/finedo/znywnetelement/delete";
	...
	public static ReturnValueDomain<FileImportResultDomain> importexcel(SysEntityfile arg) {
		String apuri="service/finedo/znywnetelement/importexcel";
	...
	public static ReturnValueDomain<SysEntityfile> exportexcel(ZnywnetelementQueryDomain arg) {
		String apuri="service/finedo/znywnetelement/exportexcel";
