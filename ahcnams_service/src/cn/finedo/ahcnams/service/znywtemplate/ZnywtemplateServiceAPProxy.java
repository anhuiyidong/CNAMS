...
public class ZnywtemplateServiceAPProxy {
	private ZnywtemplateServiceAPProxy() {
	}
			
	public static ReturnValueDomain<PageDomain<Znywtemplate>> query(ZnywtemplateQueryDomain arg) {
		String apuri="service/finedo/znywtemplate/query";
		...
		// 跨域调用，网络调用
		ReturnValueDomain<PageDomain<Znywtemplate>> ret = ServiceCaller.call(apuri + "?token=" + token, arg, new TypeReference<ReturnValueDomain<PageDomain<Znywtemplate>>>() {});
		return ret;
	}
	
	public static ReturnValueDomain<String> add(ZnywtemplateListDomain arg) {
		String apuri="service/finedo/znywtemplate/add";
	...
	public static ReturnValueDomain<String> update(ZnywtemplateListDomain arg) {
		String apuri="service/finedo/znywtemplate/update";
	...
	public static ReturnValueDomain<String> delete(ZnywtemplateListDomain arg) {
		String apuri="service/finedo/znywtemplate/delete";
	...
	public static ReturnValueDomain<FileImportResultDomain> importexcel(SysEntityfile arg) {
		String apuri="service/finedo/znywtemplate/importexcel";
	...
	public static ReturnValueDomain<SysEntityfile> exportexcel(ZnywtemplateQueryDomain arg) {
		String apuri="service/finedo/znywtemplate/exportexcel";
