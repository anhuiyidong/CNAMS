...
public class ZnywoptrecordServiceAPProxy {
	private ZnywoptrecordServiceAPProxy() {
	}
			
	public static ReturnValueDomain<PageDomain<Znywoptrecord>> query(ZnywoptrecordQueryDomain arg) {
		String apuri="service/finedo/znywoptrecord/query";
		...
		// 跨域调用，网络调用
		ReturnValueDomain<PageDomain<Znywoptrecord>> ret = ServiceCaller.call(apuri + "?token=" + token, arg, new TypeReference<ReturnValueDomain<PageDomain<Znywoptrecord>>>() {});
		return ret;
	}
	
	public static ReturnValueDomain<String> add(ZnywoptrecordListDomain arg) {
		String apuri="service/finedo/znywoptrecord/add";
	...
	public static ReturnValueDomain<String> update(ZnywoptrecordListDomain arg) {
		String apuri="service/finedo/znywoptrecord/update";
	...
	public static ReturnValueDomain<String> delete(ZnywoptrecordListDomain arg) {
		String apuri="service/finedo/znywoptrecord/delete";
	...
	public static ReturnValueDomain<FileImportResultDomain> importexcel(SysEntityfile arg) {
		String apuri="service/finedo/znywoptrecord/importexcel";
	...
	public static ReturnValueDomain<SysEntityfile> exportexcel(ZnywoptrecordQueryDomain arg) {
		String apuri="service/finedo/znywoptrecord/exportexcel";
