...
public class ZnywelementsteprelServiceAPProxy {
	private ZnywelementsteprelServiceAPProxy() {
	}
			
	public static ReturnValueDomain<PageDomain<Znywelementsteprel>> query(ZnywelementsteprelQueryDomain arg) {
		String apuri="service/finedo/znywelementsteprel/query";
		...
		// 跨域调用，网络调用
		ReturnValueDomain<PageDomain<Znywelementsteprel>> ret = ServiceCaller.call(apuri + "?token=" + token, arg, new TypeReference<ReturnValueDomain<PageDomain<Znywelementsteprel>>>() {});
		return ret;
	}
	
	public static ReturnValueDomain<String> add(ZnywelementsteprelListDomain arg) {
		String apuri="service/finedo/znywelementsteprel/add";
	...
	public static ReturnValueDomain<String> update(ZnywelementsteprelListDomain arg) {
		String apuri="service/finedo/znywelementsteprel/update";
	...
	public static ReturnValueDomain<String> delete(ZnywelementsteprelListDomain arg) {
		String apuri="service/finedo/znywelementsteprel/delete";
	...
	public static ReturnValueDomain<FileImportResultDomain> importexcel(SysEntityfile arg) {
		String apuri="service/finedo/znywelementsteprel/importexcel";
	...
	public static ReturnValueDomain<SysEntityfile> exportexcel(ZnywelementsteprelQueryDomain arg) {
		String apuri="service/finedo/znywelementsteprel/exportexcel";
